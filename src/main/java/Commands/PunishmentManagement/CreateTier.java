...
public class CreateTier extends BaseCommand {
    ...
    public CreateTier() {
        super("createtier", new String[] {"addtier"}, "createtier [punishmentName] [punishmentType] [duration]", "Creates a new punishment tier.", "", Permission.ADMINISTRATOR);
    }
    ...
    public void run(MessageReceivedEvent event, String[] args) {
        ...
        if (args.length != 3) {
        ...
        } else if (!Arrays.asList(validPunishments).contains(suppliedPunishment)) {
            ...
            if (duration == -1) {
                ...
                event.getChannel().sendMessage("Created Tier Result: " + result).queue();
